...
<body>
    ...
    $yas = $_POST["yas"];
    $mail = $_POST["mail"];
    $yazilimDili = $_POST["yazilimDili"];
    $yazilimGirisTarihi = $_POST["yazilimGirisTarihi"];
    $deneyimYili = $_POST["deneyimYili"];
    $programlamaDilleri = implode(", ", $_POST["programlamaDilleri"]);
